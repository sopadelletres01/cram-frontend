...
export default function PromocionEdit({
  eventos,
  id,
  caducado,
  titulo,
      ...
      <Card.Body>
        <div className="card__evento">
          ...
          <Form className="card__body">
            ...
            >
              <Card.Text
                style={{ display: "flex", gap: "8px", flexFlow: "column wrap" }}
              >
                {caducado ? (
                  <Badge bg="danger">Expirada</Badge>
                ) : (
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control
                    ...
                    type="date"
                    onChange={(e) =>
                      setForm({ ...form, fecha_finalizacion: e.target.value })
                    }
                  />
                </Form.Group>
                <Form.Group className="mb-3" controlId="formBasicEmail">
