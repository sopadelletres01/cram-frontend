...
background: "linear-gradient(180deg, rgba(108,172,255,1) 17%, rgba(141,235,255,1) 89%)",
            ...
            <Card.Body>
                <div style={{height:"100%",flexDirection:"column",justifyContent:"space-around",position:"relative"}} className='card__evento'>
                        ...
                        <img className='qr__promo' style={{width:"200px",height:"200px",position:"absolute",right:"0px",bottom:"0px"}} src="https://res.cloudinary.com/dhdbik42m/image/upload/v1653246688/websiteQRCode_noFrame_vcjzxh.png"></img>
                        ...
                        <div className="button__row-left" style={{display:"flex", borderRadius: "16px",justifyContent:"space-around",backgroundColor:"rgb(173 211 233)",gap:"8px",padding:"16px"}}>
