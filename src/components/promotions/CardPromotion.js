...
export default function Promotion({ onClick, caducado, title, commerce, evento, descripcion, inicio, src, final }) {
  return (
        ...
        <div className="card__evento">
          ...
          <div className="card__body">
            ...
            <Card.Text style={{ display: 'flex', gap: '8px', flexFlow: 'column wrap' }}>
              ...
              <li>
                {' '}
                Comercio: <span className="card__styleInfo">{commerce}</span>
              </li>
              <li>
              ...
              <div style={{ display: 'flex', gap: '8px', justifyContent: 'flex-end' }}>
                <Button variant="primary">ver Promotion</Button>
              </div>
            </Card.Text>
          </div>
        </div>
