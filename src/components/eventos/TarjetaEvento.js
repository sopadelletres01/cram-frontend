        ...
        <div className="card__evento">
          ...
          <div className="card__body">
            ...
            <Card.Text style={{ display: 'flex', gap: '8px', flexFlow: 'column wrap' }}>
              <li> {descripcion}</li>
              <li>
                El evento se realizará en : <span className="card__styleInfo">{lugar}</span>
              </li>
              <li>
                El evento se realizará el: <span className="card__styleInfo">{inicio}</span>
              </li>
              <li>
                {' '}
                El evento finalizará el: <span className="card__styleInfo">{final}</span>
              </li>
