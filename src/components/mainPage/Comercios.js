                ...
                { !complet ?
                    <Form id='form' onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Select name='categoria_id' aria-label='Escoge una categoria' onChange={(e)=>setComercio({...comercio, categoria_id:(e.target.value)})} required>
                                {
                                    <>
                                        <option selected hidden>Seleccion una categoria para tu comercio</option>
                                        {
