...
export default function ModificacionesCo() {
  ...
  useEffect(() => {
    async function getData() {
      let eventos = await EventsService.getEventosCurrent();
      ...
      case "opciones":
        return (
          <>
            ...
            <Button
              onClick={(e) => setFormComer("eliminar")}
              variant="danger"
              type="button"
            >
              Eliminar
      ...
      case "editar":
        return (
          <>
            ...
            <Button
              onClick={(e) => setFormComer("opciones")}
              variant="secondary"
              type="button"
            >
              Cancelar
